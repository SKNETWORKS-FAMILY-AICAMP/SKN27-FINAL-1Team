...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("POST", "/api/v1/shopping-list", {"json": {"missing_ingredients": [{"name": "tofu"}]}}),
        ("POST", "/api/v1/shopping-list/from-recipe", {"json": {"recipe_id": 1, "missing_ingredients": [{"name": "tofu"}]}}),
        ("GET", "/api/v1/shopping-list/current", {}),
        ("GET", "/api/v1/shopping-list/history", {}),
        ("GET", "/api/v1/shopping-list/1", {}),
        ("DELETE", "/api/v1/shopping-list/1", {}),
        ("PATCH", "/api/v1/shopping-list/items/1", {"json": {"is_checked": False}}),
