...
def _self_check() -> None:
    ...
    assert clean_ingredient_name("다진마늘") == "마늘"
    assert clean_ingredient_name("다진 마늘 듬뿍") == "마늘"
    assert clean_ingredient_name("다진 양파") == "양파"
    assert clean_ingredient_name("다진파") == "대파"
    assert clean_ingredient_name("참치캔") == "참치"
    assert clean_ingredient_name("참치통조림") == "참치"
    assert clean_ingredient_name("캔참치") == "참치"
    assert clean_ingredient_name("옥수수 캔") == "옥수수"
    assert clean_ingredient_name("캔옥수수") == "옥수수"
    assert clean_ingredient_name("통조림옥수수") == "옥수수"
    assert clean_ingredient_name("파마산치즈가루") == "파마산치즈"
    assert clean_ingredient_name("파마산치즈 간것") == "파마산치즈"
    assert clean_ingredient_name("냉동새우") == "새우"
    assert clean_ingredient_name("손질한 대파") == "대파"
    assert clean_ingredient_name("무 손질 후") == "무"
    assert clean_ingredient_name("고춧가루 크게") == "고춧가루"
