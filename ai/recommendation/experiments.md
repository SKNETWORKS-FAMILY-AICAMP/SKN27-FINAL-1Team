...
**L1 축·Go:** §실험 18(구) → §실험 19(informative) → §실험 **20**(Bayesian bar **채택**) · §실험 **21**(독립 감성 uniq↑ · 혼합 **미채택**).
...
| **v** | `review_n` | 리뷰 수 |
| **C** | warm \(R\)의 평균 | Bayesian prior (≈3.715) |
| **m** | 3 (고정) | 신뢰 강도 |
...
**게이트:** (1) mean(WR\|vge2)>mean(WR\|v1) **통과**. (2) ceiling uniq% WR>R **통과** (std는 수축으로 감소 — OR 조건으로 uniq 채택).
