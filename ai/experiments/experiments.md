...
**코드:** `catalog_eval` subset×bar 분해 (실험 17에서 `decomposed_*` 제거)
...
**코드:** [`score_02.py`](score_02.py), [`LightFM_Model.ipynb`](LightFM_Model.ipynb) (`EXP16=1` — **실험 17에서 해당 경로 폐기**)
...
**0~2 정의 (고정):** [`score_02.py`](score_02.py)
